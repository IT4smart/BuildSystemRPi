...
function prepare_build_env() {  
    ...
    APT_INCLUDES=apt-transport-https,apt-utils,ca-certificates,dialog,sudo,git,build-essential,bc,dh-systemd,cmake,libx11-dev,zlib1g-dev,libjpeg62-turbo-dev,xorg-server-source,autoconf,libxtst-dev,libxdamage-dev,gettext,xutils-dev,libxfont-dev
...
chroot_exec wget -P /tmp https://github.com/TigerVNC/tigervnc/archive/v1.7.1.tar.gz


# build 
echo -e "Building TigerVNC for $1"
